...
import { decrementCursor, formatMailboxCursor, incrementCursor } from './mailbox-cursor'
  ...
  return <Container>
    <Stack spacing={1} style={{ paddingTop: '8px'}}>
      ...
      <Alert severity="info">If using Gmail this should be an <a
        href="#" onClick={() => {
          openPath('https://support.google.com/mail/answer/185833?hl=en-GB')
